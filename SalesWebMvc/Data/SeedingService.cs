...
namespace SalesWebMvc.Data
{
    ...
    {
        //Criando um injetor de dependência
        private SalesWebMvcContext _context;

        //Construtor pra indicar que a injeção de dependencia deve acontecer
        public SeedingService(SalesWebMvcContext context)
        {
            _context = context;
        }
        //Operação para popular a base de dados
        public void Seed()
        {
            //Testar se o banco de dados já foi populado
            if (_context.Department.Any() || _context.Seller.Any() || _context.SalesRecords.Any())
            {
                return; //Caso o banco de dados já foi populado, corta o comando
            }

            //Caso o banco não tenha sido populado, vamos inserir os dados abaixo
            ...
            //Adicionar usando o Entity Framework
            //Usar o método AddRange que permite adicionar varios obejtos de uma só vez
            ...
            //Para salvar e confirmar as operações no banco de dados usar o método SaveChanges
